...
<html>
    ...
    <body>
        ...
        <div class="container">
            <section class="about">
                ...
                <div class="about-content">
                    <h2>Our story</h2>
                    <p>We are MotorGuard Insurance (PVT) Ltd. the largest state-owned insurer in Sri Lanka anchored to a pioneering legacy of financial stability and trust spanning over six decades.
        ...
        <div class="container1">
            <h2>Our Mission</h2>
            <p>We provide risk protection and life investment optimisation, that will deliver value to our customers through a team of committed professionals, whose contribution we recognise and value leading to superior shareholder value, whilst being a responsible corporate citizen</p>
        </div>
         <div class="container2">
                    <h2 class="our-vision">Our Vision</h2>
